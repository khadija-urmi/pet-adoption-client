...
const AdoptionRequest = () => {
    ...
    const handleAdoptionStatusChange = async (adoptUserId) => {
        await axiosPublic.patch(`/pet-adopted-req/${adoptUserId}`, { adopted: true });
        refetch();
            ...
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    {adoptReqInfo?.map((adoptUser) => (
                        <tr key={adoptUser._id} className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
