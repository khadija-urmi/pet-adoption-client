            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center">
                ...
                <div className="lg:w-1/2 lg:pl-12">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-2xl font-semibold text-blue-600 dark:text-blue-400">Our Philosophy</h3>
                        ...
                        <div>
                            <h3 className="text-2xl font-semibold text-blue-600 dark:text-blue-400">Our Organization</h3>
                            <p className="text-lg text-gray-600 dark:text-gray-300">
                        ...
                        <div>
                            <h3 className="text-2xl font-semibold text-blue-600 dark:text-blue-400">Partnerships with our team</h3>
                            <p className="text-lg text-gray-600 dark:text-gray-300">
