            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 lg:py-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12"> {/* Increased gap */}
                    <div className="flex flex-col items-center sm:items-start">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 text-center sm:text-left">
                            We are dedicated to connecting loving families with pets in need. Our mission is to ensure every pet finds a forever home where they are loved and cared for.
                        </p>
                        <h2 className="text-lg font-semibold text-gray-800 dark:text-white mt-4 mb-4">Follow Us</h2>
                        <div className="flex space-x-6">
                            <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-blue-600">
                                <FaFacebookF className="w-4 h-4" />
                            </a>
                            <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-blue-400">
                                <FaTwitter className="w-4 h-4" />
                            </a>
                            <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-pink-600">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-6">
                        <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-gray-900">Privacy Policy</a>
                        <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-gray-900">Terms & Conditions</a>
                    </div>
                </div>
            </div>
        </footer>
