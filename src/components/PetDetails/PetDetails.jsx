...
const PetDetails = () => {
  ...
  return (
    <>
      <Helmet>
        <title>WoofWow | PetDetails</title>
      </Helmet>
      <div className="flex justify-center items-center min-h-screen mt-20">
        <div className="max-w-3xl bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700">
          ...
          <div>
            <h2 className="text-4xl font-bold mb-2 tracking-tight text-gray-900 dark:text-white leading-loose">
              About me
            </h2>
            <p className="text-lg mb-3 font-normal text-gray-700 dark:text-gray-400">
              {singlePetInfo?.petFullDetail}
            </p>
          </div>
