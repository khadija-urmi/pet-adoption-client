         ...
         dark:bg-gray-900">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex justify-center">
                    <NavLink to='/login'> <button className="btn text-2xl">Log In</button></NavLink>
                    <NavLink to='/signup'> <button className="btn text-2xl">Register</button></NavLink>
                </div>
            </div>
