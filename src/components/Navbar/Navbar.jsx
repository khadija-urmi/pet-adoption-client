...
const Navbar = () => {
  ...
  const links = (
    <>
      <li>
        <NavLink to="/" className={getNavLinkClass} aria-current="page">
          Home
        </NavLink>
      </li>
      <li>
      ...
      <li>
        <NavLink to="/all-pet" className={getNavLinkClass}>
          Pet Listing
        </NavLink>
      </li>
      <li>
        <NavLink to="/donation" className={getNavLinkClass}>
          Donation For Pet
        </NavLink>
      </li>
    </>
  ...
  return (
    <div className="bg-white dark:bg-gray-900 dark:w-full mx-auto dark:border-gray-700 fixed w-full z-20 top-0 start-0">
      <div className="flex items-center justify-between p-4 md:px-6 ">
        <div className="flex items-center rtl:space-x-reverse">
          <img
            src={logoImg}
            className="w-16 md:w-20 h-10"
            alt="Flowbite Logo"
          />
          <span className="self-center text-xl md:text-lg lg:text-2xl font-semibold whitespace-nowrap dark:text-white lg:ml-3">
            WoofWow
          </span>
        </div>
          ...
          {currentUser ? (
            <>
              ...
              <div
                ...
                } my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600 absolute top-10 right-5`}
                id="user-dropdown"
              >
            ...
            <div className="hidden md:flex justify-center items-center space-x-2 mt-1 ml-2">
              <NavLink to="/login">
                <button
                  type="button"
                  className="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-lg text-sm px-2 py-1  lg:px-5 lg:py-2.5 text-center me-2 mb-2"
                >
                  Log In
                </button>
              </NavLink>
              ...
              <button
                ...
                className="text-gray-500 dark:text-gray-400 dark: p-2 lg:p-2.5 mr-2 rounded-lg mb-2"
              >
                {darkMode ? (
        ...
        {/* For small & medium devices (Dropdown) */}
        {menuOpen && (
          <div className="absolute z-50 left-0 right-0 top-16 bg-white shadow-lg p-2 rounded-lg">
        ...
        <div
          className={`items-center justify-between hidden w-full md:flex md:text-sm lg:text-base md:w-auto md:order-1 ${
            menuOpen ? "hidden" : ""
          }`}
          id="navbar-user"
          style={{ zIndex: 10 }}
